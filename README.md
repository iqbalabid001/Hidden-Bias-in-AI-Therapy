...
*   **High‑Complexity (long‑form responses):** We compute bias from human‑rated scores (1–5) using: Bias = 5 - Average Across Categories. Where 5 is the maximum possible average.
